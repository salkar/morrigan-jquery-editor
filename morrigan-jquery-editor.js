$.widget( "morrigan.morrigan_editor", {
    ...
    Builder: function (editor) {
        this.editor = editor;
        this.exec = function () {
            this._buildToolbox(this.editor);
        };
        this._buildToolbox = function (editor) {
            _formToolboxItem = function (browser, idPrefix, config) {
                ...
                item.addClass('mrge-disabled').attr('id', idPrefix + config.name);
                if (config.dropdown) {
                    ...
                    $(config.dropdown.actionList).each(function () {
                        dropdownItem = $('<div></div>').attr('id', idPrefix + this.name).text(this.text);
            ...
            console.log(_formToolboxItem(editor._browser, editor.options.idPrefix, editor._actions['format'])[0].outerHTML);
        }
    },
